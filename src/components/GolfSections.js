...
<div className='GolfSection2-1 tester'>
  ...
  <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank" align="center" className="formIndividual" style={{ pointerEvents: 'none', opacity: 0.5 }}>
...
<div className='GolfSection2-2 tester'>
  ...
  <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank" className="formIndividual" style={{ pointerEvents: 'none', opacity: 0.5 }}>
    <input type="hidden" name="cmd" value="_s-xclick" />
