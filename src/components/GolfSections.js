      ...
      <Fragment>
        <section className='GolfSection1'>
          <div className='GolfSection1-1'>
            <h3>17th Annual 2023 Nick Erdy Foundation Golf Outing</h3>
            <p className='lead'>
              will be held on June 3rd, 2023 at the Hickory Woods Golf Course in
            ...
            <p className='lead'>
              In an effort to simplify the check-in process this year, we’re
              offering all the “extras” ahead of time in these convenient
              packages! If you don’t see a package that suits your needs don’t
              worry - all individual options will still be available the day of
              the outing!
            </p>
            <p className='lead'>
