...
class Contact extends Component {
  ...
  <section className="ContactSection1">
          <div className="ContactSection1-1">
            <h3>Contact Us</h3>
            <p className="lead">Feel free to reach out to us via email or phone. We will accept donations to the silent auction year round and your monetary donations via PayPal are always appreciated.</p>
            <button type="button" class=" btn btn-facebook"><a href="https://www.facebook.com/The-Nick-Erdy-Foundation-156253388324978/" target="_blank" rel="noopener noreferrer"><i class = "fab fa-facebook-square fa-2x"></i>Check us out on Facebook</a></button>
