      ...
      <Fragment>
        ...
        <section className="BenefitSection2">
          <div className="BenefitSection2-1">
            <h3>Individual Ticket - $110/person</h3>
            ...
            >
              ...
              <table>
                ...
                <tr>
                  <td>
                    <select name="os0">
                      <option value="1 Person">1 Person $110.00 USD</option>
                      <option value="2 People">2 People $220.00 USD</option>
                      <option value="3 People">3 People $330.00 USD</option>
                      <option value="4 People">4 People $440.00 USD</option>
                      <option value="5 People">5 People $550.00 USD</option>
                      <option value="6 People">6 People $660.00 USD</option>
                      <option value="7 People">7 People $770.00 USD</option>
                    </select>
                  </td>
                </tr>
                <tr>
          ...
          <div className="BenefitSection2-2">
            <h3>Table Reservation (seats up to 10 ) - $1,100/table</h3>
            ...
            >
              ...
              <table>
                ...
                <tr>
                  <td>
                    <select name="os0">
                      <option value="1 Table">1 Table $1,100.00 USD</option>
                      <option value="2 Tables">2 Tables $2,200.00 USD</option>
                      <option value="3 Tables">3 Tables $3,300.00 USD</option>
                      <option value="4 Tables">4 Tables $4,400.00 USD</option>
                    </select>
                  </td>
                </tr>
                <tr>
